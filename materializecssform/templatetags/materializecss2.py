...
def materializecss(element, options={}):
    ...
    if options:
        ...
        help = str2bool(qs.get('help', default="True"))

    markup_classes = {'label': label_cols, 'value': '', 'single_value': '', 'icon': icon, 'help': help}
...
def render(element, markup_classes):
    ...
    if element_type == 'boundfield':
        ...
        template = get_template("materializecssform/field2.html")
...
@register.filter
def is_email(field):
    return isinstance(field.field, forms.EmailField)
